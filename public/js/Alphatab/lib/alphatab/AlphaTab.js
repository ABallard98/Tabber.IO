    ...
    if (cssFontLoadingModuleSupported){
        ...
        checkFont = function (){
			...
			var onLoaded = function (){
				if(document.fonts.check('1em alphaTab'))
				{
					AlphaTab.Environment.IsFontLoaded = true;
					console.log('Font loaded', arguments);
				}
				else
				{
					setTimeout(function() { checkFont() }, 1000);
					console.log('Font not loaded, checking later', arguments);
				}
				return true;
			};
...
AlphaTab.Model.Tuning.Initialize = function (){
    ...
    AlphaTab.Model.Tuning._sixStrings.push(new AlphaTab.Model.Tuning("Guitar Tune down ï¿½ step", new Int32Array([63, 58, 54, 49, 44, 39]), false));
    ...
    AlphaTab.Model.Tuning._fourStrings.push(new AlphaTab.Model.Tuning("Bass Tune down ï¿½ step", new Int32Array([42, 37, 32, 27]), false));
